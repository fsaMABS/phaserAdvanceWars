...
export const loadLevel = that => {
  ...
  that.game.add.text(410, 20, 'Current:', style)
  that.currentPlayer = 'blue'
  that.playerText = that.game.add.text(480, 20, that.currentPlayer, style)
  that.youAreText = that.game.add.text(400, 50, `${that.game.userId}: ${that.game.currentUser.role}`, style)
